 ...
 */
// let clicked = document.querySelector('.fa-diamond');
// console.log(clicked)

// clicked.addEventListener('click', function() {
//     console.log('hello i clicked you just now ')
// });


// click function to reset the game 
...
clickedCard.addEventListener('click', function () {
    console.log('The clickedCard button was clicked!');
  });
